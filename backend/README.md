...
## Project Structure
    ...
    ├── template_test_app_d_35763  # Django project configurations
...
1. Clone this repo and `cd template_test_app_d_35763`
...
2. Clone this repo and `cd template_test_app_d_35763`
